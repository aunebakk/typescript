...
// Generated Date: 9/9/2018 4:03:23 PM
// Template: sql2x.CrudeTypeScriptGenerator.OverallDesignTypeScriptTranby
module SQL2XTemplateCrudeTableTineScriptReadinessStateRef {
    'use strict';

    type TineScriptReadinessStateRefType = {
        tineScriptReadinessStateRcd: string,
        tineScriptReadinessStateName: string,
        dateTime: string,
        tineScriptReadinessStateRefPartitionKey: string,
        tineScriptReadinessStateRefRowKey: string
    };

    // declaration
    declare var gettineScriptReadinessStateRefList: TineScriptReadinessStateRefType[]

    // client on load
    window.onload = () => {
        var contentElement: any = document.getElementById('content');
        var dashboard = new TineScriptReadinessStateRefTiles(contentElement);
        dashboard.start();
    };

    // class
    class TineScriptReadinessStateRefTiles {
        ...
        constructor(
            ...
            // init tiles
            TineScriptReadinessStateRefTiles.tiles = new Array<Tile>();
        }
        ...
        start() {
            ...
            // resize canvas to hold all tineScriptReadinessStateRefs
            this.resizeCanvas(14 + 30);
            TineScriptReadinessStateRefTiles.clearCanvas('white');
            ...
            let header: Tile =
                new Tile(
                    ...
                    line,
                    '',
                    gettineScriptReadinessStateRefList.length,
                    14 + 30,
                    15,
                    2,
                    5,
            ...
            // header
            TineScriptReadinessStateRefTiles.tiles.push(header);

            // remaining tineScriptReadinessStateRefs
            var lastTile: Tile;

            for (let i: number = 0; i < gettineScriptReadinessStateRefList.length; i++) {
                line++;

                lastTile =
                    new Tile(
                        gettineScriptReadinessStateRefList[i].tineScriptReadinessStateRcd,
                        40,
                        line,
                        gettineScriptReadinessStateRefList[i].userId,
                        gettineScriptReadinessStateRefList.length,
                        14 + 30,
                        15,
                        2,
                ...
                TineScriptReadinessStateRefTiles.tiles.push(lastTile);
            }
            ...
            document.onmousemove = function (e) {
                ...
                if (TineScriptReadinessStateRefTiles.tiles) {
                    for (let tile of TineScriptReadinessStateRefTiles.tiles) {
